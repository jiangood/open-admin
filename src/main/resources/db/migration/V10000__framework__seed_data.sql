...
('article_about', 'about', '关于系统', '<p>欢迎使用本系统。</p>', 'HEADER_AVATAR_DROPDOWN', 10, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO sys_article (id, code, title, content, position, seq, enabled, create_time, update_time) VALUES
('article_help', 'help', '系统帮助', '<p>系统使用帮助。</p>', 'HEADER_AVATAR_DROPDOWN', 20, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
